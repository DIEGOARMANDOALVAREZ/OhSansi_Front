      ...
      <main className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-10">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-400 text-sm">
            Gestiona usuarios, roles, responsables académicos y auditorías del sistema.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-300">
              Registrar, editar y validar responsables por área o nivel.
            </p>
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-300">
              Alta, baja y modificación de cuentas del sistema y asignación de roles.
            </p>
            <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-cyan-300">
              Entrar
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
          ...
          >
            ...
            <div className="mb-3 grid h-12 w-12 place-items-center rounded-2xl bg-cyan-500/20">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                <path d="M4 4h16v16H4zM8 8h8v8H8z" stroke="#22d3ee" strokeWidth="1.6" strokeLinecap="round" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-white">Auditoría del sistema</h3>
            <p className="mt-1 text-sm text-slate-300">
              Visualiza el historial de acciones, cambios y sesiones.
            </p>
            <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-cyan-300">
              Entrar
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
